...
export default function Signup() {
  ...
  // Add async keyword here to use await inside
  ...
  return (
    <div className='flex flex-col justify-center items-center min-h-screen p-4'>
      <motion.div 
      className='p-6 backdrop-blur-md rounded-xl shadow-2xl bg-white'
      variants={container}
      initial='hidden'
      animate='visible'
      exit='exit'>
        <div className=''>
          <div className='text-center'>
            ...
            <p className='text-gray-600 mt-2 text-sm'>Sign up to begin your Moroccan adventure</p>
          </div>
        ...
        <form className='space-y-4' onSubmit={handleSubmit}>
          <div className='flex flex-col p-4'>
            ...
            <motion.button 
              type='submit' 
              className='mt-6  rounded-2xl p-3 text-white font-medium bg-gradient-to-r from-amber-300 to-amber-600 hover:from-amber-400 hover:to-amber-600 transition-all transform hover:scale-105 disabled:bg-amber-300'
              disabled={loading}
            ...
            <p className='text-center pt-4 mt-2'>Already have an account? <span className='bg-gradient-to-r from-amber-300 to-amber-600 bg-clip-text text-transparent'><Link to='/login'>Sign in</Link></span></p>
          </div>
        </form>
        </motion.div>
    </div>
